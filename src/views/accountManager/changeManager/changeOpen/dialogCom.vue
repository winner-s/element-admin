...
<template>
  ...
  >
    ...
    >
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="银行账号：" prop="sysStudentNumber">
            <el-input
              v-model="form.sysStudentNumber"
              style="width: 200px"
              size="mini"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="单位名称：" prop="sysParentName">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="变更日期：" prop="sysParentTelphone">
            <el-input
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="银行账号：" prop="sysParentName">
            <el-input
              v-model="form.sysParentName"
              style="width: 200px"
              size="mini"
        ...
        <el-col :span="12">
          <el-form-item label="账户名称：" prop="sysParentTelphone">
            <el-input
              v-model="form.sysParentTelphone"
              style="width: 200px"
              size="mini"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="银行名称：" prop="sysParentName">
            <el-input
              v-model="form.sysParentName"
              style="width: 200px"
              size="mini"
        ...
        <el-col :span="12">
          <el-form-item label="科目号：" prop="sysParentTelphone">
            <el-input
              v-model="form.sysParentTelphone"
              style="width: 200px"
              size="mini"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="开户行所在省：" prop="sysParentName">
            <el-input
              v-model="form.sysParentName"
              style="width: 200px"
              size="mini"
        ...
        <el-col :span="12">
          <el-form-item label="开户行所在市：" prop="sysParentTelphone">
            <el-input
              v-model="form.sysParentTelphone"
              style="width: 200px"
              size="mini"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="开户行名称：" prop="sysParentName">
            <el-input
              v-model="form.sysParentName"
              style="width: 200px"
              size="mini"
        ...
        <el-col :span="12">
          <el-form-item label="联行号：" prop="sysParentTelphone">
            <el-input
              v-model="form.sysParentTelphone"
              style="width: 200px"
              size="mini"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="账户用途：" prop="sysParentName">
            <el-input
              v-model="form.sysParentName"
              style="width: 200px"
              size="mini"
        ...
        <el-col :span="12">
          <el-form-item label="是否直联：" prop="sysParentTelphone">
            <el-input
              v-model="form.sysParentTelphone"
              style="width: 200px"
              size="mini"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="变更申请人：" prop="sysParentName">
            <el-input
              v-model="form.sysParentName"
              style="width: 200px"
              size="mini"
