...
export default {
  ...
  created() {
    for (var i = 3; i < 15; i++) {
      this.list.push({
        htbh: 'JY' + Math.round(Math.random() * (9999988 - 1000000) + 1000000),
        htmc: 'GK' + Math.round(Math.random() * (9999988 - 1000000) + 1000000),
        dklx: Math.round(Math.random() * (9999988 - 1000000) + 1000000),
        zqr: '二级单位',
        zwr: '三级单位',
        dkbz: Math.round(Math.random() * (3 - 1) + 1),
        dkqx: Math.round(Math.random() * (9999988 - 1000000) + 1000000),
        ksrq: '2020-11-' + Math.round(Math.random() * (30 - 10) + 10),
        jsrq: '2020-11-' + Math.round(Math.random() * (30 - 10) + 10),
        jkje: Math.round(Math.random() * (9999988 - 1000000) + 1000000),
        jedx: 1,
        llzhts: 1,
        jxfs: 1,
        fxfs: 1,
