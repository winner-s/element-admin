...
<template>
  ...
  >
    ...
    >
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="周期编号：" prop="sysStudentNumber">
            <el-input
              v-model="form.sysStudentNumber"
              style="width: 200px"
              size="mini"
        ...
        <el-col :span="12">
          <el-form-item label="周期名称：" prop="sysStudentName">
            <el-input
              v-model="form.sysStudentName"
              style="width: 200px"
              size="mini"
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="是否受上级周期控制：" prop="sysParentName">
            <el-input
      ...
      <el-row>
        <el-col :span="12">
          <el-form-item label="周期是否控制付款：" prop="sysParentName">
            <el-input
              v-model="form.sysParentName"
              style="width: 200px"
              size="mini"
